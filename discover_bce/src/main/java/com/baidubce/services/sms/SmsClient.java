...
public class SmsClient extends SmsClientSupport {
     ...
     *
     * @see QueryMessageDetailRequest
     * @see QueryMessageDetailResponse
     */
     ...
     *
     * @see CreateTemplateRequest
     * @see CreateTemplateResponse
     */
     ...
     *
     * @see GetTemplateDetailRequest
     * @see GetTemplateDetailResponse
     */
     ...
     *
     * @see StatReceiverRequest
     * @see StatReceiverResponse
     */
