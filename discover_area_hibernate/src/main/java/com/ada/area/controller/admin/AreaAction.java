package com.ada.area.controller.admin;
...
public class AreaAction {
	...
	public String list(Pageable pageable, @RequestParam(value="pid",defaultValue = "1") Integer pid,ModelMap model) {
		...
		List<Area> tops = manager.findByTops(pid);
	...
	public String save(Pageable pageable,Area bean,ModelMap model) {
	...
	public String update(Pageable pageable, Area bean,  RedirectAttributes redirectAttributes, ModelMap model) {

		String view="redirect:/admin/area/view_list.htm";
		try {
			manager.update(bean);
